...
const ReportAdmin = () => {
    ...
    const { data: reportedItems = [], refetch, isLoading } = useQuery({
        ...
        queryFn: () => fetch('https://assignment-12-server-sanjidaakterafia0307.vercel.app/books/reported', {
            headers: {
    ...
    const handleDelete = (id) => {
        console.log(id)
        fetch(`https://assignment-12-server-sanjidaakterafia0307.vercel.app/books/reported/${id}`, {
            method: "DELETE",
            headers: {
